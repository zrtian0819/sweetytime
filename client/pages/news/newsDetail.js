        ...
        <>
            ...
            <div className='container'>
                <div className={`${styles['LYT-newsDetailAll']}`}>
                    ...
                    <span></span>
                    <h4 className={`${styles['.LYT-ceated']}`}>by 甜覓小編 2024/09/25</h4>
                    
                    <Image src={'/photos/articles/eatDessertTime.jpg'} width={1000} height={500} alt="文章" />

                    <div className='LYT-newsDetail-content ms-4 me-4'>
                        <p>
                            偷偷告訴妳，檸檬塔的故事
                            這是一道傳統且歷史久遠，並且已有多樣化演變的甜點。從名稱 Tarte au Citron 或許會直接聯想到甜點王國-法國，不過檸檬塔最早緣起和流行於地中海一帶，而法國的檸檬塔最早起源自法國南部城市-芒通 (Menton, France)。在芒通每年會舉辦檸檬節，其中檸檬塔始終是節慶的一大亮點。而由於檸檬塔的獨到好滋味，現在在法國的甜品店，咖啡廳或下午茶坊都可以看到它的身影，近年來台灣、日本也受法國甜點文化感染，於是也有越來越多的店，和越來越多師傅開始製作檸檬塔。

                            其中點燃大眾對檸檬塔的好奇的契機則在幾年前一部講述英國國寶級美食作家 Nigel Slater 的電影『吐司：敬！美味人生』(《Toast》)，當中 Nigel 和繼母比拚的檸檬塔，那光澤的蛋白霜和紮實黃澄澄的檸檬奶油餡，讓觀眾看得嘆為觀止又忍不住在螢幕前流口水，而 Reckless Cook 則是在拜讀法國甜點大師 Pierre Hermé 的食譜，乘著潮流加上好朋友兼食客的提議下，在 Reckless Oven 出產的第一項客製產品！
