				...
				<div className={`${styles['LYT-newsDetailAll']}`}>
					...
					<div className="LYT-newsDetail-content ms-4 me-4">
						<p>
							...
							其中點燃大眾對檸檬塔的好奇的契機則在幾年前一部講述英國國寶級美食作家
							Nigel Slater 的電影『吐司：敬！美味人生』(《Toast》)，當中 Nigel
							和繼母比拚的檸檬塔，那光澤的蛋白霜和紮實黃澄澄的檸檬奶油餡，讓觀眾看得嘆為觀止又忍不住在螢幕前流口水，而
							Reckless Cook 則是在拜讀法國甜點大師 Pierre Hermé
							的食譜，乘著潮流加上好朋友兼食客的提議下，在 Reckless Oven
							出產的第一項客製產品！ 自己動手做食譜 (6吋) I.檸檬奶油醬 檸檬汁 50 cc
							萊姆汁 35 cc 雞蛋 2 顆 奶油 180g 香草莢 1條 (7g香草籽) 檸檬皮 1顆
							II.塔皮 低筋麵粉 160g 糖 40~60g (根據需要甜度調整) 杏仁粉 80g 奶粉 6og
							奶油 120g III. 蛋白霜 蛋白 3~5個 (根據裝飾量調整) 糖 180~300g
							製作手續三步驟 1. 首先先煮製檸檬奶油醬。
