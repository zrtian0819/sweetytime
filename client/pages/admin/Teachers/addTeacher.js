...
const AddTeacher = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:3005/api/teacher', formData, {
            ...
            <AdminLayout>
                <Box className={`${styles.container}`}>
                    <form onSubmit={handleSubmit} encType="multipart/form-data">
                        ...
                        <TextField label="簡介" name="description" value={teacherData.description} onChange={handleInputChange} multiline rows={8} fullWidth />
