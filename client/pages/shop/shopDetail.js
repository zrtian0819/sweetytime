...
export default function ShopDetail() {
	...
	return (
		<>
			<Header />
			<div
				className={`${styles['TIL-shopDetailALL']} container-fluid d-flex flex-md-row flex-column-reverse p-0`}
			>
				{/* Sidebar for Circle Logos */}
				<div className="row col-12 col-md-3 col-xl-3 d-flex flex-row flex-md-column gap-2 mx-auto my-5 position-md-fixed">
					{circleLogos.map((logo, index) => (
						<div key={index} className={`${styles['TIL-sideBarCircle']} mx-auto p-0`}>
							<Image
								src={logo}
								alt={`Logo ${index + 1}`}
								width={70}
				...
				<div className="col-md-9 col-xl-9 mx-auto me-lg-0 my-5 flex-column d-flex me-0 gap-5">
					<h1 className="p-lg-5 p-md-3 px-3 text-white">{shop.name}</h1>
					<div className="d-flex flex-md-row justify-content-center flex-column-reverse px-md-3 px-lg-5">
						<div
							className={`${styles['TIL-shop-left']} col-lg-8 col-md-8 mx-lg-5 d-flex flex-column pe-md-2 me-md-3 col-12 p-3 p-lg-0`}
						>
